...
void test_copy_quick_srcs();
void test_copy_quick_const_srcs();
void test_copy_quick_dests();
void test_copy_quick_const_dests();

go_bandit([] {
    describe("copying from a bitter::bit_iterator", [] {
        test_copy_quick_srcs();
        test_copy_quick_dests();
    });
    describe("copying from a bitter::const_bit_iterator", [] {
        test_copy_quick_const_srcs();
        test_copy_quick_const_dests();
    });
});
